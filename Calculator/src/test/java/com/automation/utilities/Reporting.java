...
public class Reporting extends TestListenerAdapter {
	...
	public void onStart(ITestContext testContext) {
		...
		htmlReporter.config().setDocumentTitle("Calculator Web Application"); // Tile of report
	...
	public void onTestFailure(ITestResult tr) {
		...
		String screenshotPath = System.getProperty("user.dir") + "/Screenshots/" + " "+BaseClass.repName +".png";
